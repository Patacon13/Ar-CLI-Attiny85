...
cmd = 'md '+nombreSalida+' & DEL .\\'+nombreSalida+'\\' + nombreSalida+'.c /Q & DEL .\\'+nombreSalida+'\\'+nombreSalida+'.ino /Q & copy .\\'+nombre+'.c .\\'+nombreSalida+'\\'+nombreSalida+'.ino & cls & pause & arduino-cli compile --fqbn arduino:avr:uno '+nombreSalida+' & pause & exit'
os.system(cmd)
